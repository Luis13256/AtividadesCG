...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Hello Textures - Erico!", nullptr, nullptr);
    ...
    glm::mat4 projection = glm::mat4(1.0f); // matriz identidade
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::scale(model, glm::vec3(1920.0f * 0.5f, 1080.0f * 0.5f, 1.0f));
